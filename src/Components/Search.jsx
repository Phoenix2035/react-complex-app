            ...
            <div className="search-overlay-top shadow-sm">
                <div className="container container--narrow">
                    ...
                    <input
                        ...
                        autoFocus type="text" autoComplete="off" id="live-search-field" className="live-search-field"
                ...
                <div className="container container--narrow py-3">
                    ...
                    <div
                                ...
                                <div className="list-group shadow-sm">
...

                                    {
                                        state.results.map(post => {
                                            ...
                                            return (
                                                <Link onClick={() => appDispatch({type: 'closeSearch'})} key={post._id}
                                                      to={`/post/${post._id}`}
                                                    ...
                                                    <span
                                                        className="text-muted small">by {post.author.username} on {dateFormatted} </span>
                                                </Link>
                                            )
                                        })}
                                </div>
                            )}
                        {
                            ...
                            <p className='alert alert-danger text-center shadow-sm'>Sorry, we could not found any result
                                for that search</p>
                        }
                    </div>
                </div>
