        ...
        switch (action.type) {
            ...
            case 'emailUniqueResults':
                if (action.value) {
                    ...
                    draft.email.message = 'That email already being used.'
                } else {
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                autoComplete="off"/>
                            <CSSTransition classNames='liveValidateMessage' in={state.username.hasError} timeout={330}
                                           unmountOnExit>
                                <div
                                    className='alert alert-danger small liveValidateMessage'>{state.username.message}</div>
                            </CSSTransition>
                        </div>
                        <div className="form-group">
                            ...
                            <input
                                ...
                                autoComplete="off"/>
                            <CSSTransition classNames='liveValidateMessage' in={state.email.hasError} timeout={330}
                                           unmountOnExit>
                                <div
                                    className='alert alert-danger small liveValidateMessage'>{state.email.message}</div>
                            </CSSTransition>
                        </div>
                        <div className="form-group">
